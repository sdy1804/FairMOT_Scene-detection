...
class JDETracker(object):
    ...
    def update(self, im_blob, img0):
        ...
        with torch.no_grad():  
            ...
            print("scene shape : ",output_Scene.shape, 'scene_type :',type(output_Scene), 'scene:\n', output_Scene)
            predicted_class = output_Scene.argmax(dim=-1, keepdim=True)
            print('predicted_class :', predicted_class, 'predicted_class_type :', type(predicted_class))
            ...
            # print("id shape ", id_feature.shape, "id:\n", id_feature)
