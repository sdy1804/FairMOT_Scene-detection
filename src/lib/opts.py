...
class opts(object):
    def __init__(self):
        ...
        #                          default='',  # ctdet_coco_dla_2x.pth
        #                          help='path to pretrained model')
        self.parser.add_argument('--load_model_FairMOT',
                                 default='../models/resnet18_epoch150.pth',
                                 help='path to pretrained model')
        self.parser.add_argument('--load_model_Scene',
                                 default='../models/FairMOT_classhead_v5.pth',
                                 help='path to pretrained model')
        ...
        self.parser.add_argument('--input-video',
                                 type=str,
                                 default='../videos/all_vids.mp4',  # '../videos/MOT16-03.mp4'
        ...
        self.parser.add_argument('--data_cfg', type=str,
                                 default='../src/lib/cfg/SWIM.json',  # 'mot15.json',
                                 help='load data from cfg')
        self.parser.add_argument('--data_dir',
                                 type=str,
                                 default='/mnt/storage1/FairMOT_auto/dataset')
