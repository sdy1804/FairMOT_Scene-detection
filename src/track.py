...
from lib.tracker.multitracker_orig import JDETracker
...
def main(opt,
    ...
    for seq in seqs:
        ...
        if save_videos:
            ...
            cmd_str = 'ffmpeg -f image2 -i {}/%05d.jpg -b 5000k -c:v mpeg4 -r 30 {}'.format(
...
if __name__ == '__main__':
    ...
    if opt.val_mot15:
        seqs_str = '''SWIM-02
                      ...
                      SWIM-14
                      '''
        data_root = os.path.join(opt.data_dir, 'SWIM/images/train')
    if opt.val_mot20:
        seqs_str = '''MOT20-01
                      MOT20-02
                      MOT20-03
